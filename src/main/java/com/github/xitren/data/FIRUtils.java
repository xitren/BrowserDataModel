/*
 * Copyright (C) 2018 Encephalon Gusev Arsenty <xitren@ya.ru>
 *
 ...
 *
 * @author Gusev Arsenty (xitren@ya.ru)
 */
public final class FIRUtils {
     ...
     *
     * @param order Filter order.
     * @param fcl   Lower filter cutoff.
     * @param fch   Higher filter cutoff.
     * @param fs    Filter sampling rate.
     * @return The FIR filter.
     */
     ...
     *
     * @param transitionWidth The transition width in Hz
     ...
     *
     * @param m           Size of the FIR filter.
     * @param attenuation Attenuation in dB.
     * @param fs          Sampling frequency.
     ...
     *
     * @param inout In and output FIR filter.
     * @param in    Second FIR filter.
     * @return inout.
     */
