...
public final class NMath {
    ...
    private NMath() { /* forbidden */
    }

    /**
     * Returns min if x is less than min, max if x is greater than max and
     * x otherwise.
     *
     * @param x   Value
     * @param min Minimum
     ...
     *
     * @param v Number to normalize
     * @return 0 if abs(v) is smaller than Float.MIN_NORMAL
     */
     ...
     *
     * @param v Number to normalize
     * @return 0 if abs(v) is smaller than Double.MIN_NORMAL
     */
